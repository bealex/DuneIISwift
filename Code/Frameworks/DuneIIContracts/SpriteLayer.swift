...
public struct SpriteLayer: Sendable, Equatable {
    ...
    /// Whether to draw the frame mirrored horizontally (the W half of a directional sprite).
    public var flipped: Bool
    /// Pixel offset from the entity's draw origin (e.g. a turret's per-orientation nudge).
    public var offsetX: Int
    public var offsetY: Int

    public init(spriteIndex: Int, flipped: Bool = false, offsetX: Int = 0, offsetY: Int = 0) {
