...
public struct HouseInfo: Sendable, Equatable {
    ...
    public static let table: [HouseInfo] = [
        HouseInfo(
            name: "Harkonnen", toughness: 200, degradingChance: 85, degradingAmount: 3,
            minimapColor: 144, specialCountDown: 600, starportDeliveryTime: 10,
            prefixChar: ascii("H"), specialWeapon: 1, musicWin: 6, musicLose: 3, musicBriefing: 24,
            voiceFilename: "nhark.voc"
        ),
        HouseInfo(
            name: "Atreides", toughness: 77, degradingChance: 0, degradingAmount: 1,
            minimapColor: 160, specialCountDown: 300, starportDeliveryTime: 10,
            prefixChar: ascii("A"), specialWeapon: 2, musicWin: 7, musicLose: 4, musicBriefing: 25,
            voiceFilename: "nattr.voc"
        ),
        HouseInfo(
            name: "Ordos", toughness: 128, degradingChance: 10, degradingAmount: 2,
            minimapColor: 176, specialCountDown: 300, starportDeliveryTime: 10,
            prefixChar: ascii("O"), specialWeapon: 3, musicWin: 5, musicLose: 2, musicBriefing: 26,
            voiceFilename: "nordo.voc"
        ),
        HouseInfo(
            name: "Fremen", toughness: 10, degradingChance: 0, degradingAmount: 1,
            minimapColor: 192, specialCountDown: 300, starportDeliveryTime: 0,
            prefixChar: ascii("O"), specialWeapon: 2, musicWin: 5, musicLose: 2, musicBriefing: 65535,
            voiceFilename: "afremen.voc"
        ),
        HouseInfo(
            name: "Sardaukar", toughness: 10, degradingChance: 0, degradingAmount: 1,
            minimapColor: 208, specialCountDown: 600, starportDeliveryTime: 0,
            prefixChar: ascii("H"), specialWeapon: 1, musicWin: 6, musicLose: 3, musicBriefing: 65535,
            voiceFilename: "asard.voc"
        ),
        HouseInfo(
            name: "Mercenary", toughness: 0, degradingChance: 0, degradingAmount: 1,
            minimapColor: 224, specialCountDown: 300, starportDeliveryTime: 0,
            prefixChar: ascii("M"), specialWeapon: 3, musicWin: 7, musicLose: 4, musicBriefing: 65535,
