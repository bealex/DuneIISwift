...
public struct LandscapeInfo: Sendable, Equatable {
    ...
    private static func entry(
        _ movementSpeed: [UInt8],
        _ letUnitWobble: Bool,
        _ isValidForStructure: Bool,
        _ isSand: Bool,
        _ isValidForStructure2: Bool,
        _ canBecomeSpice: Bool,
        _ craterType: UInt8,
        _ radarColour: UInt16,
        _ spriteID: UInt16
    ) -> LandscapeInfo {
        LandscapeInfo(
            movementSpeed: movementSpeed,
            letUnitWobble: letUnitWobble,
            isValidForStructure: isValidForStructure,
            isSand: isSand,
            isValidForStructure2: isValidForStructure2,
            canBecomeSpice: canBecomeSpice,
            craterType: craterType,
            radarColour: radarColour,
            spriteID: spriteID
        )
    }
}
