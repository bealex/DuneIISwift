...
public enum ExplosionTables {
    public static let commands: [[ExplosionCommandStruct]] = [
        /* 00 impactSmall */
        [
            e(.setSprite, 153), e(.setTimeout, 3), e(.bloomExplosion, 0), e(.setSprite, 153), e(.setTimeout, 3),
            e(.stop, 0),
        ],
        /* 01 impactMedium */
        [
            e(.setSprite, 154), e(.bloomExplosion, 0), e(.setTimeout, 3), e(.setSprite, 153), e(.setTimeout, 3),
            e(.setSprite, 154), e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 02 impactLarge */
        [
            e(.setSprite, 183), e(.playVoice, 50), e(.bloomExplosion, 0), e(.tileDamage, 0), e(.setTimeout, 15),
            e(.setSprite, 184), e(.setTimeout, 15), e(.stop, 0),
        ],
        /* 03 impactExplode */
        [
            e(.setSprite, 183), e(.playVoice, 49), e(.bloomExplosion, 0), e(.tileDamage, 0), e(.setTimeout, 3),
            e(.setSprite, 184), e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 04 saboteurDeath */
        [
            e(.setSprite, 203), e(.playVoice, 51), e(.bloomExplosion, 0), e(.tileDamage, 0), e(.setTimeout, 7),
            e(.setSprite, 204), e(.setTimeout, 3), e(.setSprite, 205), e(.setTimeout, 3), e(.setSprite, 206),
            e(.setTimeout, 3), e(.setSprite, 207), e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 05 saboteurInfiltrate */
        [
            e(.setRandomTimeout, 60), e(.setSprite, 203), e(.playVoice, 41), e(.bloomExplosion, 0), e(.tileDamage, 0),
            e(.setTimeout, 7),
            e(.setSprite, 204), e(.setTimeout, 3), e(.setSprite, 205), e(.setTimeout, 3), e(.setSprite, 206),
            e(.setTimeout, 3), e(.setSprite, 207), e(.setTimeout, 3), e(.stop, 0),
        ],
        ...
        [
            ...
            e(.setSprite, 199), e(.setTimeout, 3), e(.setSprite, 200), e(.setTimeout, 3), e(.setSprite, 201),
            e(.setTimeout, 3), e(.setSprite, 202), e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 07 deviatorGas */
        [
            e(.setSprite, 208), e(.playVoice, 39), e(.setTimeout, 15), e(.setSprite, 209), e(.setTimeout, 15),
            e(.setSprite, 210), e(.setTimeout, 15),
            e(.setSprite, 211), e(.setTimeout, 15), e(.setSprite, 212), e(.setTimeout, 15), e(.stop, 0),
        ],
        /* 08 sandBurst */
        [
            e(.setSprite, 156), e(.playVoice, 40), e(.bloomExplosion, 0), e(.setTimeout, 7), e(.setSprite, 157),
            e(.setTimeout, 3),
            e(.setSprite, 158), e(.setTimeout, 3), e(.setSprite, 157), e(.setTimeout, 3), e(.tileDamage, 0),
            e(.stop, 0),
        ],
        /* 09 tankFlames */
        [
            ...
            + (0 ..< 5).flatMap { _ in
                [
                    e(.setSprite, 168), e(.setTimeout, 15), e(.setSprite, 169), e(.setTimeout, 15), e(.setSprite, 170),
                    e(.setTimeout, 15),
                ]
            }
            + [ e(.stop, 0) ],
        /* 10 wheeledVehicle */
        [
            e(.setSprite, 151), e(.playVoice, 49), e(.bloomExplosion, 0), e(.tileDamage, 0), e(.setTimeout, 7),
            e(.setSprite, 152), e(.setTimeout, 7), e(.stop, 0),
        ],
        /* 11 deathHand */
        [
            e(.setRandomTimeout, 60), e(.setSprite, 188), e(.playVoice, 51), e(.bloomExplosion, 0), e(.tileDamage, 0),
            e(.setTimeout, 7),
            e(.setSprite, 189), e(.setTimeout, 3), e(.setSprite, 190), e(.setTimeout, 3), e(.setSprite, 191),
            e(.setTimeout, 3), e(.setSprite, 192), e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 12 unused12 */
        [
            e(.setSprite, 213), e(.setTimeout, 15), e(.setSprite, 214), e(.setTimeout, 15), e(.setSprite, 215),
            e(.setTimeout, 15),
            e(.setSprite, 216), e(.setTimeout, 15), e(.setSprite, 217), e(.setTimeout, 30), e(.stop, 0),
        ],
        /* 13 sandwormSwallow */
        [
            e(.setSprite, 218), e(.setTimeout, 15), e(.setSprite, 219), e(.setTimeout, 15), e(.setSprite, 220),
            e(.setTimeout, 15),
            e(.setSprite, 221), e(.setTimeout, 15), e(.setSprite, 222), e(.setTimeout, 30), e(.stop, 0),
        ],
        /* 14 structure */
        [
            e(.setRandomTimeout, 60), e(.setSprite, 188), e(.playVoice, 51), e(.setTimeout, 7), e(.setSprite, 189),
            e(.bloomExplosion, 0), e(.screenShake, 0),
            e(.setTimeout, 3), e(.setSprite, 190), e(.setTimeout, 3), e(.setSprite, 191), e(.setTimeout, 3),
            e(.setSprite, 192), e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 15 smokePlume */
        [
            e(.setSprite, 183), e(.playVoice, 49), e(.moveYPosition, -80), e(.setTimeout, 3), e(.setSprite, 184),
            e(.setTimeout, 3),
        ]
            + (0 ..< 6).flatMap { _ in
                [
                    e(.setSprite, 180), e(.setTimeout, 15), e(.setSprite, 181), e(.setTimeout, 15), e(.setSprite, 182),
                    e(.setTimeout, 15), e(.setSprite, 181), e(.setTimeout, 15),
                ]
            }
            + [ e(.stop, 0) ],
        /* 16 ornithopterCrash */
        [
            e(.setSprite, 203), e(.playVoice, 49), e(.bloomExplosion, 0), e(.setAnimation, 0), e(.setTimeout, 3),
            e(.setSprite, 204), e(.setSprite, 207), e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 17 carryallCrash */
        [
            e(.setSprite, 203), e(.playVoice, 49), e(.bloomExplosion, 0), e(.setAnimation, 4), e(.setTimeout, 3),
            e(.setSprite, 204), e(.setSprite, 207), e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 18 miniRocket */
        [
            e(.setSprite, 183), e(.playVoice, 54), e(.bloomExplosion, 0), e(.setTimeout, 3), e(.setSprite, 184),
            e(.setTimeout, 3), e(.stop, 0),
        ],
        /* 19 spiceBloomTremor */
        [
            e(.setSprite, 156), e(.playVoice, 40), e(.screenShake, 0), e(.setTimeout, 7), e(.screenShake, 0),
            e(.setSprite, 157), e(.setTimeout, 3),
            e(.screenShake, 0), e(.setSprite, 158), e(.setTimeout, 3), e(.screenShake, 0), e(.setSprite, 157),
            e(.setTimeout, 3), e(.screenShake, 0), e(.tileDamage, 0), e(.stop, 0),
        ],
    ]
}
