...
struct UnitLogicTests {
    ...
    func setOrientation() {
        ...
        UnitLogic.setOrientation(&u, orientation: 64, rotateInstantly: false, level: 0)
        ...
        UnitLogic.setOrientation(&u, orientation: -56, rotateInstantly: false, level: 0)
        #expect(u.orientation[0].speed == -4)

        // Instant snap.
        UnitLogic.setOrientation(&u, orientation: 50, rotateInstantly: true, level: 1)
    ...
    func rotate() {
        ...
        u.orientation[0].current = 0; u.orientation[0].target = Int8(truncatingIfNeeded: 200); u.orientation[0].speed = -4
        UnitLogic.rotate(&u, level: 0)
    ...
    func setSpeed() {
        ...
        UnitLogic.setSpeed(&h, speed: 255, gameSpeed: 2)
        ...
        var c = unit(.carryall)
        UnitLogic.setSpeed(&c, speed: 255, gameSpeed: 4)
