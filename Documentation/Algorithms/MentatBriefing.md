...
- **Slice 2 — animation**: port `GUI_Mentat_Animation` cadence (mouth sprite cycle 0..4, eye blink timers per-house, shoulder wiggle). Runs every frame; deterministic amplitude-driven pattern (no phoneme sync in OpenDUNE).
