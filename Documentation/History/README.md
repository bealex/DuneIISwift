...
- [2026-06-08](2026-06-08.md) — original app icon for both clients (a single sun setting over Arrakis dunes), procedurally generated by `Scripts/gen-app-icon.swift`; iOS asset catalog + macOS `.icns` + `Scripts/bundle-mac.sh` to brand the macOS `.app`.
