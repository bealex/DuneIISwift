...
- [2026-05-31](2026-05-31.md) — Phase 4 rendering: headless `SpriteKitRenderer.snapshot` capture + the pixel-exact `RenderGoldenTests` harness; then faithful tile-overlay transparency, partial fog-of-war soft edges, and the sandworm shimmer (CoreGraphics blur) — the renderer's world content has no outstanding gaps. Also moved History to per-day files.
